...
class Button(Box):
    ...
    def draw(self):
        # draws the button
        # If the mouse is within the boundaries of the button it changes to its active colour 'ac'
    ...
    def click(self):
        ...
        # returns None if the button hasnt been pressed and call the function 'action'
